...
```yaml
      uses: search-rug/student-friendly-report@v1.1
      with:
...
This action is used as a part of a workflow implemented on Maven projects. You can look at an example of this workflow in use [here](https://github.com/search-rug/student-friendly-report-example).
...
If you want to implement this workflow check the usage [here](https://github.com/search-rug/student-friendly-report-example#usage) in the usage section.

The explanation of the feedback report can be seen [here](https://github.com/search-rug/student-friendly-report-example#feedback-report) in the feedback report section.
